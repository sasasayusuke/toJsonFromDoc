...
class Gui(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.entry_api_key = tk.Entry(self, width=UI_LONG_INPUT_WIDTH)
        ...
        self.entry_server = tk.Entry(self, width=UI_LONG_INPUT_WIDTH)
        ...
        self.entry_site = tk.Entry(self, width=UI_LONG_INPUT_WIDTH)
    ...
    def initialize_default_values(self):
        ...
        self.entry_input_dir.insert(0, config.DEFAULT_DOCUMENT_DIRECTORY)
        self.entry_output_dir.insert(0, config.DEFAULT_DOCUMENT_DIRECTORY)
