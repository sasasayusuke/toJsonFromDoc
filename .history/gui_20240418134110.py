...
class Gui(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.entry_input_dir = tk.Entry(self, width=UI_LONG_WIDTH)
        ...
        self.entry_output_dir = tk.Entry(self, width=UI_LONG_WIDTH)
        ...
        self.entry_api_key = tk.Entry(self, width=UI_LONG_WIDTH)
        ...
        self.entry_server = tk.Entry(self, width=UI_LONG_WIDTH)
        ...
        self.entry_site = tk.Entry(self, width=UI_LONG_WIDTH)
